...
export default function NewEvent({createEvent, user}) {
  ...
  return (
    <Flex minH={'100vh'} align={'center'} justify={'center'} 
          ...
          bgSize="100%" backgroundRepeat="no-repeat"
    >
            ...
            <>
              ...
              <Flex justify={'center'} justifyContent={'space-between'} alignContent={'center'} wrap={'wrap'} >
                ...
                <FormControl id="location" >
                  ...
                  <Input id="location" placeholder="Type something..." value={event.location} name="location" onChange={handleInputChange} />
                </FormControl>

                <FormControl id="type_of_event" >
                  <FormLabel>Event type</FormLabel>

                  <Select placeholder="Select..." value={event.type} name="type" onChange={handleInputChange} >
                    <option>Food</option>
                    <option>Music</option>
                    <option>Sport</option>
                ...
                <Flex w={'100%'} mt={3} >
                  <FormControl id="duration" >
                    ...
                    <NumberInput defaultValue={1} min={1} max={24} clampValueOnBlur={false} allowMouseWheel>
                      <NumberInputField value={event.duration} name="duration" onChange={handleInputChange} />
                    </NumberInput>
                  </FormControl>
                  ...
                  <FormControl id="limit" >
                    ...
                    <NumberInput min={1} max={99999} clampValueOnBlur={false} allowMouseWheel >
                      <NumberInputField value={event.limit} name="limit" onChange={handleInputChange} />
                    </NumberInput>
                  </FormControl>
                </Flex>
              </Flex>
              ...
              <FormControl mt={4} mb={4} >
                <InputGroup>
                  ...
                  <Input id="photo" placeholder="Insert a link to your event photo" value={event.photo} name="photo" onChange={handleInputChange} />
                </InputGroup>
              </FormControl>

              <Stack direction="row" spacing={4} justify="center" >
                <RouterLink to='/events' >
                  <Button align={'center'} bg={'custom.200'} w={'30vh'} color={'white'} type="submit" _hover={{ bg: 'custom.300' }} onClick={handleSubmit} >
                    Create
                  </Button>
                </RouterLink>
              </Stack>
