  ...
  return (
    ...
    >

      {
        !event ?
        <Spinner /> :
        <Box w={'60%'} minW={'60%'} maxW={'60%'} bg={'gray.50'} marginTop={50}
            borderRadius="md" boxShadow={'md'} m={20} h={'60vw'} maxH={'80vw'} >

          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: .4 } }} >
            <Wrap w={'100%'} align={'center'} p={1} >

              <Box w={'50%'}  minW={'300px'}>
                <Image borderRadius="md" boxShadow="md" src={event.photo} alt="" />
              </Box>
